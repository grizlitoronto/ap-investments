  ...
  return (
    <div className="flex items-center gap-4">
      <div className="flex h-16 w-16 items-center justify-center rounded-[1.35rem] border border-[#b89b63]/55 bg-gradient-to-br from-[#f8f2e8] to-[#e8ddc9] shadow-[0_8px_24px_rgba(111,90,51,0.12)] sm:h-20 sm:w-20">
        <span className="ml-1 text-base font-semibold tracking-[0.38em] text-[#6f5a33] sm:text-lg">APG</span>
      </div>
      <div>
        <div className="text-base font-semibold uppercase tracking-[0.26em] text-slate-900 sm:text-lg">A.P.G Investments Ltd.</div>
        <div className="mt-1 text-xs uppercase tracking-[0.3em] text-[#8b6f3d] sm:text-[13px]">Private Investment Firm</div>
      </div>
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[#f8f5ef] text-slate-900">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-6 sm:px-8 lg:px-10">
          ...
          <div className="grid items-start gap-10 py-14 lg:grid-cols-[1.2fr_0.8fr] lg:py-20">
            ...
            <div className="grid gap-4 self-end">
              <div className="rounded-3xl border border-[#c9a96a]/20 bg-gradient-to-br from-white/8 to-white/4 p-6 backdrop-blur-sm">
              ...
              <div className="rounded-3xl border border-[#c9a96a]/20 bg-gradient-to-br from-white/8 to-white/4 p-6 backdrop-blur-sm">
                ...
                <div className="mt-2 text-3xl font-semibold">Pre seed and seed</div>
              </div>
              <div className="rounded-3xl border border-[#c9a96a]/20 bg-gradient-to-br from-white/8 to-white/4 p-6 backdrop-blur-sm">
                <div className="text-sm text-white/60">Approach</div>
                <div className="mt-2 text-3xl font-semibold">Selective and operator led</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="thesis" className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#8b6f3d]">Investment thesis</div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {thesis.map((item) => (
              <div key={item} className="rounded-3xl border border-[#d7c7aa] bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
      ...
      <section className="border-y border-[#d7c7aa] bg-[#f3ede4]">
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-10">
          <div className="mb-10 max-w-2xl">
            <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#8b6f3d]">Why founders work with us</div>
            <h2 className="mt-4 text-4xl font-semibold leading-tight tracking-[-0.03em] text-slate-900 sm:text-5xl">
              More than capital.
            </h2>
          </div>
          <div className="grid gap-5 md:grid-cols-3">
            {values.map((item) => (
              <div key={item.title} className="rounded-3xl border border-[#d7c7aa] bg-white p-7 shadow-[0_12px_32px_rgba(15,23,42,0.05)]">
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
        <div className="mb-16 grid gap-5 md:grid-cols-3">
          {differentiators.map((item) => (
            ...
            >
              <div className="text-sm font-semibold uppercase tracking-[0.24em] text-[#8b6f3d]">Why A.P.G</div>
              <h3 className="mt-4 text-2xl font-semibold tracking-[-0.02em] text-slate-900">{item.title}</h3>
              <p className="mt-4 text-sm leading-7 text-white/70">{item.text}</p>
            </div>
          ))}
        </div>
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#8b6f3d]">What we look for</div>
            <h2 className="mt-4 text-4xl font-semibold leading-tight tracking-[-0.03em] text-slate-900 sm:text-5xl">
              Clear founder quality and clear upside.
            </h2>
            <div className="mt-8 space-y-4">
              {criteria.map((item) => (
                <div key={item} className="flex items-start gap-4 rounded-2xl border border-[#d7c7aa] bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.03)]">
          ...
          <div>
            <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#8b6f3d]">Process</div>
            <h2 className="mt-4 text-4xl font-semibold leading-tight tracking-[-0.03em] text-slate-900 sm:text-5xl">
              Simple and founder friendly.
            </h2>
            <div className="mt-8 space-y-5">
              {process.map((item) => (
                <div key={item.step} className="rounded-3xl border border-[#d7c7aa] bg-white p-6 shadow-[0_10px_28px_rgba(15,23,42,0.04)]">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-10">
          <div className="rounded-[2rem] border border-[#d7c7aa] bg-white p-6 shadow-sm sm:p-10 lg:flex lg:items-start lg:justify-between lg:gap-10">
            <div className="max-w-2xl">
              <div className="text-sm font-semibold uppercase tracking-[0.3em] text-[#8b6f3d]">Contact</div>
              <h2 className="mt-4 text-4xl font-semibold leading-tight tracking-[-0.03em] text-slate-900 sm:text-5xl">
            ...
            <div className="mt-8 w-full lg:mt-0 lg:w-[460px]">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full rounded-full bg-white px-6 py-3 text-sm font-semibold text-neutral-950 transition hover:scale-[1.01]"
                >
                  Submit inquiry
                </button>
