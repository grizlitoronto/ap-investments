        ...
        <div className="relative mx-auto max-w-7xl px-5 py-6 sm:px-8 lg:px-10">
          ...
          <div className="grid items-center gap-8 py-10 lg:grid-cols-[1.05fr_0.95fr] lg:py-14">
            <div className="max-w-2xl">
              ...
              <h1 className="max-w-3xl text-[2.75rem] font-semibold leading-[0.98] tracking-[-0.035em] text-slate-900 sm:text-5xl lg:text-[3.9rem]">
            ...
            <div className="grid gap-4 self-center lg:pl-4">
